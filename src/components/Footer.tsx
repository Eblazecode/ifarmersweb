        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">iFarmers Limited</span>
            </div>
            <p className="text-gray-300 text-sm">Innovating agriculture for a sustainable future across Africa.</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              ...
              <li><Link to="/services" className="hover:text-[#7CB342]">Agri Software</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li className="flex items-center space-x-2"><Phone className="h-4 w-4" /><span>+254 700 123 456</span></li>
              <li className="flex items-center space-x-2"><Mail className="h-4 w-4" /><span>info@ifarmers.co.ke</span></li>
              <li className="flex items-start space-x-2"><MapPin className="h-4 w-4 mt-1" /><span>Nairobi, Kenya</span></li>
            </ul>
          </div>
        </div>
