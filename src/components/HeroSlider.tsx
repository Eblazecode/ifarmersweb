      ...
      <section className="flex flex-col lg:flex-row min-h-[600px]">
        ...
        <div className="lg:w-1/2 bg-gradient-to-br from-[#2D5016] to-[#1a3009] flex items-center justify-center p-8 lg:p-16">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-3xl lg:text-5xl font-bold text-white mb-4 transition-all duration-500">
            ...
            <Link
                ...
                className="inline-block bg-[#7CB342] hover:bg-[#689f38] text-white font-semibold px-8 py-4 rounded-lg transition-colors"
            >
              {slides[current].cta}
            </Link>
              ...
              {slides.map((_, i) => (
                  <button
                      ...
                      className={`w-3 h-3 rounded-full transition-colors ${
                          i === current ? 'bg-[#7CB342]' : 'bg-white/50'
                      }`}
                  />
              ))}
            </div>
